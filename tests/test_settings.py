...
class TestDefaultSettings:
    ...
    def test_default_base_folder_name(self):
        ...
        assert default_settings["auto_check_updates"] == True
    ...
    def test_default_proxy_settings(self):
        ...
        assert defaults["use_proxy"] == False
...
class TestBaseDirectoryLogic:
    ...
    def test_macos_default_directory(self):
        ...
        if sys.platform == "darwin":
            expected_base = os.path.expanduser("~/Library/Application Support/Kemono Downloader")
    ...
    def test_directory_path_is_absolute(self):
        ...
        if sys.platform == "win32":
            base_dir = os.path.join(os.getenv("APPDATA", os.path.expanduser("~")), "Kemono Downloader")
        elif sys.platform == "darwin":
            base_dir = os.path.expanduser("~/Library/Application Support/Kemono Downloader")
        else:
            base_dir = os.path.join(os.getenv("XDG_DATA_HOME", os.path.expanduser("~/.local/share")), "Kemono Downloader")
...
class TestQSettingsIntegration:
    ...
    def test_qsettings_value_types(self):
        ...
        try:
            ...
            assert settings.value("test_bool", type=bool) == True
        finally:
            # Cleanup
            settings.clear()
